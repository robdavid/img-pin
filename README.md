...
* Provide the ability for downstream projects to build a custom tools with policy rules for image age, image name transformation, trusted repositories etc. It also allows custom YAML documents to provide Helm templating.
